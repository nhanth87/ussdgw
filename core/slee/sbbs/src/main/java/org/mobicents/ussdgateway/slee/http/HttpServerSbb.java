...
public abstract class HttpServerSbb extends ChildServerSbb implements SriParent {
	...
	/**
	 * Performance optimization: Cache HTTP session activity to avoid O(n) iteration.
	 * volatile for thread-safe access.
	 */
	private volatile HttpSessionActivity cachedHttpSessionActivity = null;
	
	/**
	 * Track HTTP session ID for correlation and debugging.
	 * This CMP field is declared in sbb-jar.xml as 'httpSessionId'.
	 */
	protected String httpSessionIdCMP;
